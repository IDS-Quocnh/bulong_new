    ...
    <div class="flex" id="app">
        <div class="px-4 lg:px-24 lg:w-5/12 h-full">
            <div class="flex  justify-center items-center ">
                <img src="public/images/logo.png" class="lg:w-56" />
            </div>
            <div>
        ...
        <div class="p-8 lg:block bg-cover guest-right-panel-wrapper" style="background-image: url('images/background1.png'); background-repeat: no-repeat;">
