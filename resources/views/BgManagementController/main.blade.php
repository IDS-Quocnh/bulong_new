@extends('layouts.atllayout', ['title' => isset($item) ? 'Edit Background' : 'Add Background' ])
...
<div class="card">
    ...
    <div class="top-card-button-wrapper">
        <a href="{{route('bg-management')}}" type="button" class="btn btn-primary btn-sm">back</a>
    </div>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" {{ isset($item) ? 'action=' . route('bg-management/edit') :'action=' . route('bg-management/add')  }}  enctype="multipart/form-data" >
                        {{ csrf_field() }}
