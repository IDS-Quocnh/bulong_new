...
@section('content')
    ...
    <div class="top-profile mt-2 full-width" >
       <img src="/public/allimage/love-letter.png" class="mr-auto mt-4"  style="width: 100px;height: 100px">
        <div style="text-align: center" class="font-bold mt-2">My Felt Confessions</div>
