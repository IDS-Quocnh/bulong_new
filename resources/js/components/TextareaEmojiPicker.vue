<template>
    <div class="textarea-emoji-picker">
        <picker v-show="showEmojiPicker" @select="addEmoji" title="Pick your emoji..." emoji="point_up" />
        ...
        <textarea ref="textarea" class="textarea text-xl bg-cover bg-center" :value="value" @input="$emit('input', $event.target.value)" placeholder="I have something to confess..." :style="{'background-image': `url(${backgroundImage})`}"></textarea>
    </div>
</template>
<script>
